...
function transformEditorMonthlyEarningsInfoChartJs(editorEarnings: Metric.EditorMonthlyEarnings): ChartProps['data']{
...
export default transformEditorMonthlyEarningsInfoChartJs